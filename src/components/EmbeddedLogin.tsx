...
export default function EmbeddedLogin({ onLogin }: EmbeddedLoginProps) {
      ...
      <div style={{ position: 'absolute', bottom: '-5%', left: '50%', transform: 'translateX(-50%)', zIndex: 10, width: '100%', maxWidth: '380px', padding: '0 1rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '1rem', gap: '0.75rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            ...
            />
            <label htmlFor="el-remember" style={{ color: 'rgba(0,255,65,0.4)', fontSize: '9px', fontFamily: 'monospace', cursor: 'pointer' }}>
              OTURUMU AÇIK TUT
            </label>
          </div>
          <button
        ...
        <div style={{ marginTop: '0.75rem', textAlign: 'center' }}>
          ...
          <p className="el-blink" style={{ color: 'rgba(0,255,65,0.25)', fontSize: '9px', fontFamily: 'monospace' }}>
