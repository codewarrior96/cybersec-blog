...
export default function SystemMonitorWidget() {
  ...
  return (
    <div className="h-full w-full flex flex-col font-mono border border-green-500/20 bg-[#0a1114]/80 rounded-sm shadow-[0_0_15px_rgba(0,0,0,0.5)] backdrop-blur-sm overflow-hidden">
      
      {/* Outer grouped header */}
      <div className="flex justify-between items-center px-4 py-3 border-b border-green-500/20 z-10 bg-[#0a1114]">
      ...
      <div className="flex-1 flex flex-col gap-4 p-4 mt-2">
        ...
        <div className="flex-1 flex flex-col relative overflow-hidden group">
          ...
          <div className="flex-1 w-full relative -mx-2 mt-2 border-b border-cyan-500/10">
          ...
          <div className="flex justify-between text-[8px] text-slate-500 mt-1 px-1 pt-1 opacity-70">
            <span>0</span><span>20%</span><span>40%</span><span>60%</span><span>48M</span>
          </div>
        </div>

        {/* NETWORK TRAFFIC */}
        <div className="flex-1 flex flex-col relative overflow-hidden group mt-2">
          ...
          <div className="flex-1 w-full relative -mx-2 mt-2 border-b border-orange-500/10">
            <ResponsiveContainer width="105%" height="100%">
        ...
        {/* MEMORY USAGE */}
        <div className="flex-[0.6] min-h-[60px] flex flex-col justify-center relative group mt-4">
          ...
          <div className="relative w-full h-6 bg-[#00111a] border border-cyan-500/30 rounded-sm shadow-[inset_0_0_10px_rgba(0,0,0,0.8)] overflow-hidden">
          ...
          <div className="flex justify-between text-[8px] text-slate-500 mt-2 border-t border-cyan-500/10 pt-1 opacity-70">
